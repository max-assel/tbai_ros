...
class Controller {
   public:
     ...
     * @return tbai_ros_msgs::JointCommandArray : ROS message with joint commands
     */
    virtual tbai_ros_msgs::JointCommandArray getCommandMessage(scalar_t currentTime, scalar_t dt) = 0;
