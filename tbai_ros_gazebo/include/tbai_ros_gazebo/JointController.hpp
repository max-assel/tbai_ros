...
class JointController : public controller_interface::Controller<hardware_interface::EffortJointInterface> {
   ...
   private:
    ...
    void jointCommandCallback(const tbai_ros_msgs::JointCommandArrayConstPtr &commandArrayPtr);
    ...
    realtime_tools::RealtimeBuffer<tbai_ros_msgs::JointCommandArray> commandBuffer_;
