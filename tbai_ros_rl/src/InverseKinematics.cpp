...
std::unique_ptr<InverseKinematics> getInverseKinematicsUnique() {
    ...
    auto a3 = tbai::core::fromRosConfig<scalar_t>("bob_controller/ik/a3");
    auto a4 = tbai::core::fromRosConfig<scalar_t>("bob_controller/ik/a4");
    auto defaultStance = tbai::core::fromRosConfig<matrix_t>("bob_controller/default_stance");
