...
std::unique_ptr<CentralPatternGenerator> getCentralPatternGeneratorUnique() {
    auto period = tbai::core::fromRosConfig<scalar_t>("bob_controller/cpg/period");
    auto time_offsets = tbai::core::fromRosConfig<vector_t>("bob_controller/cpg/time_offsets");
    auto swingHeight = tbai::core::fromRosConfig<scalar_t>("bob_controller/cpg/swing_height");
